...
;hljs.registerLanguage("markdown",e)})();/*! `swift` grammar compiled for Highlight.js 11.6.0 */
...
;hljs.registerLanguage("rust",e)})();/*! `php` grammar compiled for Highlight.js 11.6.0 */
(()=>{var e=(()=>{"use strict";return e=>{
